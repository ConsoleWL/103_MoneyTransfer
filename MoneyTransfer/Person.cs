...
namespace MoneyTransfer
{
    internal class Person
    {
        ...
        public void DisplayInfo()
        {
            ...
            Console.WriteLine($"Name: {name}, wallet: {wallet.money}");
        }
        ...
        public bool TransferMoney(Person receiver, int amountToTransfer)
        {
            ...
            if(amountToTransfer <= wallet.money)
            {
                ...
                Console.WriteLine($"Name: {name} is succesfully transfered ${amountToTransfer}  to {receiver.name}");
                return true;
            }
            else
            {
                Console.WriteLine("Tranfer cancelled, not enough funds on the account");
                return false;
            }
